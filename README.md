...
不想自己编译？直接到 [Releases](https://github.com/xiabuqiu123/novel-ai-assistant/releases) 下载 `novel-ai-assistant-v1.0-windows.zip`，解压后双击「启动书镜辨章.bat」即可使用；首次使用需在「模型与 API 设置」里填入自己的模型服务地址与密钥。
